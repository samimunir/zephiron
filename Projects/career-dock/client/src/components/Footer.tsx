...
const Footer = () => {
  return (
    <footer className="w-full absolute bottom-0 bg-zinc-900 shadow-2xl px-64 py-8 flex items-center justify-between border-t-2 border-amber-500 cursor-default">
      <div>
